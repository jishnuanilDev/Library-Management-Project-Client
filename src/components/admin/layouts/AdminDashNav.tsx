...
import AdminDataTable from "../tables/DashBoardTable";
...
function AdminDashNav() {
  ...
  const handleLogout = () => {
    ...
    localStorage.removeItem("adminLibraryToken");
  ...
  return (
    <>
          ...
          <Toolbar disableGutters>
            ...
            <Box sx={{ flexGrow: 1, display: { xs: "flex", md: "none" } }}>
              ...
              >
                ...
                <MenuItem onClick={handleClickBooks}>
            ...
            <Box sx={{ flexGrow: 0 }}>
              ...
              >
                <MenuItem >
                  <Typography sx={{ textAlign: "center" }}>{admin.adminEmail}</Typography>
                </MenuItem>
      ...
      {showUsers ? <UserDataTable /> : <AdminDataTable />}
    </>
  );
}
